package com.alluxio.benchmarks.sparktwo
...
object CustomOptimizationExample {
  ...
  def main(args: Array[String]) {
    ...
    val df = sparkSession.read.option("header","true").csv("/Users/peis/workspace/spark2.0-examples/src/main/resources/sales.csv")
